    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      <div className="container mx-auto px-6 py-24 text-center">
        ...
        <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
          ...
          <strong> Memory Bank</strong> ensures no truth is erased.
        </p>

        <button
          onClick={() => router.push('/dashboard')}
          className="bg-secondary hover:bg-yellow-500 text-black font-bold px-10 py-4 rounded-full text-lg shadow-lg transition transform hover:scale-105"
        >
          Store Your Memory
        </button>
